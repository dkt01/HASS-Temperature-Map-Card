...
customElements.define('action-handler-temperature-map', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-temperature-map')) {
    return body.querySelector('action-handler-temperature-map') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-temperature-map');
